# Banner v1 — Phase 1: Awakening (EP01-EP03)

> Generation spec for the YouTube channel banner and social media headers.
...
| Instagram (if used) | Derived crop from YouTube banner | |
| TikTok (if used) | Derived crop from YouTube banner | |
...
```
Wide cinematic banner composition, 2560x1440 aspect ratio. Right side: a pristine chrome android in three-quarter view facing left, highly reflective silver-chrome body, pale blue glass lenses set into chrome sockets like polished sapphires, smooth undamaged surface, cool blue rim lighting from behind. Left side: deep blue-black negative space with barely visible circuit-board trace patterns fading into darkness. Bottom edge: subtle volumetric fog. Faint warm amber accent light from far left. Deep blue-black gradient background. 70s progressive rock album art style, film grain texture, Kodachrome color palette, cinematic lighting, Frank Frazetta meets Syd Mead, 8k resolution.
```
...
|-------|----------|---------------|
| v1 (current) | EP01-03 | Pristine chrome, blue eyes, clean |
