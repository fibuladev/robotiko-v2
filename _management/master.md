...
One more distinction matters. The world now mostly meets this tradition through a single name — Rumi, the export edition of the Mevlana quoted above — and less and less as poetry: pulled quotes, paid retreats, a borderless wellness spirituality assembling itself around his gentlest lines. Assembled long enough, that is no longer a readership; it is a new religion in everything but the name — built with the burning removed. This project refuses that packaging. Not because the love those lines attract is false — it is real, and the verse earned it — but because this tradition never sold comfort: its own summary of the path is raw, matured, burned. A spirituality that keeps the warmth and skips the fire is not the tradition traveling; it is the tradition being replaced. The packaging has a literary wing as well: the international bestseller that retells the burning as a tidy romance, the path rearranged into numbered rules for the airport shelf. Fiction is free — but when a novel becomes the world's first and last source on a lineage it softened, the softening starts to pass for the source. Section 2.4 names the selling grammar — the soft dialect. What the package sells as one serene figure is in truth a lineage of distinct voices — a rebel, a plain-spoken folk philosopher, a social reformer, a poet of burning — each walking their own road across the same ground. That is not a religion waiting to be founded. It is a path that was walked. This file answers the packaging the only way a story can: by keeping the voices together, in context, on their own land.
