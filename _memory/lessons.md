...
- **RULE:** The word **"Sufi" is FORBIDDEN** anywhere in the project — it is an orientalist veneer and not our frame. Render mysticism/spirituality as UNIVERSAL, lived, earned EXPERIENCE — the image and the felt thing, never an exotic costume or tradition label. Philosophical/literary sources may inform the design privately, but are never worn as decoration in deliverables. (Aligns with master Section 2.4 Twin Arrogances / anti-guru stance.) (Added 2026-06-04)
