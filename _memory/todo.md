...
- [ ] **NEXT: launch-day sequence** (private runbook; repo public BEFORE premiere goes live — card/description links must not 404). At publish: fill {PLAYLIST_URL}/{EP09_URL}, retro-update EP09 "Next:", banner v5 + About Phase 4.
