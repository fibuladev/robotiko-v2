...
**End card:** 6 finished 1920×1080 PNGs in `episode-10/05_video/raw/`. Round 1 (A/B/C: single art line + URL) judged by Fibula as too cryptic for strangers — right call. Round 2 adds the explanation tier (poem on top / plain-English meaning line / URL): `endcard_D.png` (*I came to walk beside.* + "Every prompt, script and decision behind this film is public." — 10 words, fits 4s), `endcard_E.png` (THIS SERIES IS OPEN SOURCE. + "Story, prompts, pipeline — the complete making of ten films." — 12 words), `endcard_F.png` (poem + full framing sentence + "All of it is open source." — 18 words, needs the 5s card). Claude's recommendation: **D**. Guide §8 updated. **AWAITING Fibula's pick.**
