...
- [ ] **NEXT: "Package EP10 for YouTube" (separate session)** → then launch-day sequence (private runbook; repo public BEFORE premiere goes live — card/description links must not 404)
