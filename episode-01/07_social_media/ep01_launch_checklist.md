...
## PHASE 2: YOUTUBE UPLOAD (April 22, Morning)
...
## PHASE 3: LAUNCH DAY SCHEDULE (April 22)
...
## PHASE 4: POST-LAUNCH (April 22 Evening + April 23)
...
- [ ] Episode folder completeness check:
  ...
  - [ ] `05_video/` ✅
  - [ ] `06_edit/` ✅
  - [ ] `07_social_media/` — youtube_package, social_atomization, launch_checklist ✅
...
| Narrative spoilers | Description mentions "journey begins" — no spoilers |
...
After EP01: **No banner update needed.** Banner v1 (pristine chrome) is correct through EP03.
Next banner update: After EP03 release → Banner v2 (subtle cracks).
