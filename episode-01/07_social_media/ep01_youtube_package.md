...
```
ROBOTIKO v2.0 — EP01: "The Cycle Break" | Anatolian Psychedelic Rock
```

Characters: 64 / 100 max ✅
...
```
Count the numbers. They will return.
```
...
**Primary tags:**
```
robotiko, robotiko v2, robotiko v2.0, anatolian rock, anadolu rock, prog rock, progressive rock, concept album, 70s rock, psychedelic rock, psikedelik rock, suno ai, ai music
```

**Episode-specific tags:**
```
the cycle break, first contact, chrome android, symbiosis, turkish philosophy, sci-fi music, concept album video, music video, cyberanatolian
```

**Combined (paste into YouTube):**
```
robotiko, robotiko v2, anatolian rock, anadolu rock, prog rock, progressive rock, concept album, 70s rock, psychedelic rock, psikedelik rock, ai music, the cycle break, first contact, chrome android, symbiosis, turkish philosophy, sci-fi music, cyberanatolian, music video
```

Characters: ~298 / 500 max ✅

---

## 5. THUMBNAIL GUIDANCE

- **Recommended scene:** S39-S40 — First Contact (human and robot fingers reaching toward each other, spark of fire at near-contact)
- **NO text on thumbnail.** Episode number "01" only, bottom-left corner, small, white or amber serif font.
- **Color emphasis:** Boost warm amber/gold tones. The spark between the fingers should be the brightest point.
- **Composition:** Rule of thirds — fingers meeting at the center intersection point. Dark background vignette to make the spark pop on the YouTube grid.
- **Progression note:** This is the first thumbnail. It sets the "pristine" baseline. EP02+ thumbnails should show progressive degradation of Robotiko's chrome body.

---

## 6. END SCREEN RECOMMENDATIONS

- **Next episode:** Not available on launch day (EP02 not yet published). Update end screen when EP02 goes live.
- **Playlist:** Link to "ROBOTIKO v2.0 — The Complete Journey" playlist
- **Subscribe CTA:** "The journey is ten episodes long. Subscribe to walk beside."
...
- **Category:** Music
- **Language:** English
- **Visibility:** Scheduled premiere for April 22, 2026 at 18:00 CET
- **Comments:** Allow all (moderation on)
- **Premiere:** Enable premiere with countdown (builds anticipation for first episode)
