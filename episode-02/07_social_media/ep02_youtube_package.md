...
- [x] Call-response chorus pairs on single lines (Leonard Cohen style) ✅
- [x] AABB couplet punctuation: comma/semicolon within, period at stanza end ✅
- [x] Ellipsis preserved only for intentional pauses (ear loss, outro fade) ✅
- [x] "..." between Bangladesh and Paris represents skipped Chorus 2 + instrumentals ✅
- [x] Grand Finale chorus included (same lyrics, but weight is different after the ear) ✅
- [x] Outro as spoken word trailing off ✅
...
**EP02-specific tags:**
```
the tech guru's downfall, global collapse tour, dark comedy, tech guru, silicon valley
```
...
- **Scene:** S02 — Messianic Podium (Robotiko at elevated podium, arms spread wide, holographic data streams behind, audience silhouettes below)
- **"02" only** — bottom-left corner, small, italic white serif font. No other text.
- **Color emphasis:** Gold spotlight on chrome body against cool blue data backdrop. Warm amber boost +15, vignette +30.
- **Why S02:** Establishes the "Tech Guru" premise instantly. The confident, messianic pose is the promise the song systematically dismantles. Contrast with EP01's cosmic finale (S64) creates visual arc: EP01 = wonder, EP02 = hubris.
- **Progression note:** EP01 thumbnail = cosmic, two characters, hopeful. EP02 thumbnail = corporate, solo, overconfident. The visual arc begins: from the stars to a conference hall. The fall has started.
- **Alternative:** S31 (War Zone, just before ear loss) — shows battle damage, darker tone. Use if "pristine → cracked" progression is prioritized over narrative setup.
