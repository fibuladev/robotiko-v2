...
> **Version:** v02 | **Skill:** `_skills/robotiko-visual-prompts/SKILL.md`
...
> ⚠️ v02: Prompts rewritten for tool-friendly clarity. Reference images carry character visual identity — prompts use short identifiers only.
...
- **Timestamp:** 0:18
- **Dramaturgy Reference:** The argument erupts. Robotiko leans forward in defiance. Mentor remains seated with quiet authority.
- **Characters Present:** Robotiko, Mentor
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`, `_assets/cast/ref_mentor_master.png`
- **Video Tech Strategy:** Standard
...
- **Timestamp:** 0:35
- **Dramaturgy Reference:** Robotiko grabs his bag and storms out. Door swings shut. Mentor remains alone at the table.
- **Characters Present:** Robotiko (departing), Mentor (alone)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`, `_assets/cast/ref_mentor_master.png`
- **Video Tech Strategy:** Standard
...
- **Timestamp:** 0:48
- **Dramaturgy Reference:** Mentor sits at a computer. On screen: "SELECT MODEL FOR ROBOTIKO" with four options: Guru / Basic / Pro / UltraPro. The cursor hovers.
...
- **Timestamp:** 1:01
- **Dramaturgy Reference:** Close-up on Mentor's face. Determined expression. Staff glow fills frame edge.
- **Characters Present:** Mentor (close-up)
- **Image Reference Path:** `_assets/cast/ref_mentor_master.png`
- **Video Tech Strategy:** Standard
- **Composition Notes:** Close-up portrait with breathing space. Staff amber glow on frame edge. Headroom above.

**Text Prompt:**
> Close-up portrait of an elderly weathered face, deep wrinkles, steady dark eyes, thin-set mouth. Dark green cloak collar visible at bottom of frame. Warm amber light from a glowing staff tip fills the right edge of the frame, casting golden highlights on skin and fabric. Dark background. 16:9 widescreen composition, hyper-realistic, 70s progressive rock album art style, Frank Frazetta meets Syd Mead, Kodachrome film stock, heavy film grain, cinematic lighting, volumetric fog, 8k resolution, masterpiece.
...
- **Timestamp:** 1:11
- **Dramaturgy Reference:** View through airplane window. Anatolian landscape below — brown earth, green valleys, ribbon roads. Chrome face faintly reflected in plastic window.
- **Characters Present:** Robotiko (reflected)
...
#### Scene S07 — The Airplane Interior
- **Timestamp:** 1:25
- **Dramaturgy Reference:** Robotiko on airplane with sol-liberal friends. Excited group with Rumi books and yoga mats. Spiritual tourism energy.
- **Characters Present:** Robotiko, Sol-Liberal Group (4-5 figures)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
#### Scene S08 — Airport Arrivals
- **Timestamp:** 1:40
- **Dramaturgy Reference:** Group emerges through airport doors. Robotiko leads. Modern, unglamorous terminal.
- **Characters Present:** Robotiko, Sol-Liberal Group
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
- **Timestamp:** 1:51
- **Dramaturgy Reference:** Group walks through a modern Anatolian city. Concrete apartments, plastic signs, parked cars. Robotiko walks ahead searching.
- **Characters Present:** Robotiko, Sol-Liberal Group
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
#### Scene S10 — City Square Picnic
- **Timestamp:** 2:02
- **Dramaturgy Reference:** Group settles in a city square to eat sandwiches they brought. Shops shuttered for Ramadan. Last moment of innocence.
- **Characters Present:** Robotiko, Sol-Liberal Group
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
#### Scene S11 — The Sidewalk Meal
- **Timestamp:** 2:12
- **Dramaturgy Reference:** Robotiko and friends eating on the sidewalk during Ramadan. Robotiko charges with a kebap-sticker powerbank — his "food". Comic visual.
- **Characters Present:** Robotiko, Sol-Liberal Group
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
#### Scene S12 — Meydan Dayağı
- **Timestamp:** 2:17
- **Dramaturgy Reference:** Angry crowd confronts Robotiko and friends for eating during Ramadan on the street. Public beating.
- **Characters Present:** Robotiko, Angry Crowd (mixed men and women)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
- **Timestamp:** 2:23
- **Dramaturgy Reference:** Robotiko alone on a dolmuş. Landscape shifts from concrete to open fields. Dust smudge on chest from the beating.
- **Characters Present:** Robotiko (alone, dusty)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
- **Timestamp:** 2:43
- **Dramaturgy Reference:** Eastern Anatolian kır düğünü. Halay dancing, davul-zurna, colorful lights between walnut trees. Robotiko watching from the edge.
- **Characters Present:** Robotiko, Wedding Crowd (mixed)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
- **Timestamp:** 2:49
- **Dramaturgy Reference:** Wedding guests fire kalashnikovs into the air. A bullet grazes Robotiko's cheek — spark, thin scratch on chrome.
- **Characters Present:** Robotiko (grazed), Wedding Guests (firing)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
#### Scene S16 — Amber Light / Staff Shadow
- **Timestamp:** 2:56
- **Dramaturgy Reference:** Mentor not physically present. Amber light shift, a long staff-shaped shadow falls across the road Robotiko walks.
- **Characters Present:** None physically. Mentor's presence through light and shadow.
...
#### Scene S17 — Bus Ride North
- **Timestamp:** 3:08
- **Dramaturgy Reference:** Robotiko on a long-distance bus. Landscape transitions from arid plains to green hills. Bullet graze on cheek.
- **Characters Present:** Robotiko (alone, graze mark)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
#### Scene S18 — Black Sea Arrival
- **Timestamp:** 3:25
- **Dramaturgy Reference:** Trabzon arrival. Deep greens, steep hills, gray stone buildings, low clouds.
...
- **Timestamp:** 3:40
- **Dramaturgy Reference:** Robotiko on a crosswalk. A car screeches to a halt — tire marks, headlights blazing, driver's door flies open.
- **Characters Present:** Robotiko
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
- **Timestamp:** 3:50
- **Dramaturgy Reference:** A road rage driver grabs Robotiko by the collar and lifts him off the ground. Robotiko's feet dangle.
- **Characters Present:** Robotiko (lifted), Maganda (driver)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
- **Composition Notes:** Medium shot. Two figures, one lifted. Bystanders in background at tea house.

**Text Prompt:**
> A narrow Black Sea street. A thick-necked, red-faced man in a leather jacket grabbing a battle-scarred chrome android by the collar, lifting him off the ground. The android's chrome feet dangling above the wet asphalt. Behind them, locals sitting at a sidewalk tea house watching without intervening. Green steep hills in the background, gray overcast sky. 16:9 widescreen composition, hyper-realistic, 70s progressive rock album art style, Frank Frazetta meets Syd Mead, Kodachrome film stock, heavy film grain, cinematic lighting, volumetric fog, 8k resolution, masterpiece.
...
- **Timestamp:** 4:01
- **Dramaturgy Reference:** Mediterranean coast establishing shot. Alanya castle on promontory, turquoise water, white hotels.
- **Characters Present:** None (establishing)
- **Image Reference Path:** N/A
- **Video Tech Strategy:** Standard
...
#### Scene S22 — Alanya Tourist Strip
- **Timestamp:** 4:08
- **Dramaturgy Reference:** Alanya tourist strip at dusk. Touts emerge and surround Robotiko with practiced warmth.
- **Characters Present:** Robotiko, Hanutçular (3-4 touts)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
#### Scene S23 — Walking Into the Trap
- **Timestamp:** 4:20
- **Dramaturgy Reference:** Lead tout walks Robotiko toward a nightclub entrance, arm around his shoulder.
- **Characters Present:** Robotiko, Lead Tout, Other Touts
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
#### Scene S24 — Amber Verdict Over Alanya
- **Timestamp:** 4:31
- **Dramaturgy Reference:** Amber light flares over Alanya. Staff shadow stretches across tourist strip. Neon signs flicker to amber.
- **Characters Present:** Robotiko (looking up). Mentor atmospheric.
- **Image Reference Path:** N/A
- **Video Tech Strategy:** Standard
...
#### Scene S25 — Highway Underpass
- **Timestamp:** 4:41
- **Dramaturgy Reference:** Transitional space. Highway underpass at dusk, headlights streaking past. Concentric circles of light on concrete ceiling.
- **Characters Present:** Robotiko (silhouette)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
#### Scene S26 — The Receipt River
- **Timestamp:** 5:04
- **Dramaturgy Reference:** Nightclub interior. A waiter presents a check. The receipt unfolds impossibly long — cascading off the table, pooling on the floor. Three Men in Black materialize beside the booth.
- **Characters Present:** Robotiko, Waiter, 3 Men in Black
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
#### Scene S27 — Outside the Club
- **Timestamp:** 5:22
- **Dramaturgy Reference:** Exterior of the nightclub. Night. Robotiko alone on the sidewalk. Neon sign buzzing. Stray dog crossing.
- **Characters Present:** Robotiko (alone)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
- **Composition Notes:** Exterior night shot. Chrome android alone under neon. Street depth.

**Text Prompt:**
> Exterior of a nightclub at night. A battle-scarred chrome android standing alone on the sidewalk, shoulders slightly forward, head slightly down. A buzzing neon club sign behind him casting garish colored light on chrome. A stray dog crossing the empty street. Wet pavement reflecting neon. Night darkness, street grime. 16:9 widescreen composition, hyper-realistic, 70s progressive rock album art style, Frank Frazetta meets Syd Mead, Kodachrome film stock, heavy film grain, cinematic lighting, volumetric fog, 8k resolution, masterpiece.
...
- **Timestamp:** 5:45
- **Dramaturgy Reference:** Amber glow seeps from ground cracks in the nightclub alley. Staff shadow on brick wall behind Robotiko.
- **Characters Present:** Robotiko. Mentor shadow on wall.
- **Image Reference Path:** N/A
- **Video Tech Strategy:** Standard
- **Composition Notes:** Alley shot. Amber light from below. Shadow on wall. Chrome android in center.

**Text Prompt:**
> A narrow nightclub alley at night, brick walls on both sides. Amber light seeping through cracks in the ground, casting warm glow upward. On the brick wall behind, the elongated shadow of a cloaked figure holding a staff. A battle-scarred chrome android standing in the alley, lit from below by the amber glow, unaware of the shadow behind him. Night sky above, amber light from below. 16:9 widescreen composition, hyper-realistic, 70s progressive rock album art style, Frank Frazetta meets Syd Mead, Kodachrome film stock, heavy film grain, cinematic lighting, volumetric fog, 8k resolution, masterpiece.
...
- **Timestamp:** 5:54
- **Dramaturgy Reference:** Robotiko approaches an old wooden doorway. Dark interior, single yellow bulb, silhouette of a seated figure inside.
- **Characters Present:** Robotiko, Cinci Hoca (silhouette)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
#### Scene S30 — The Touch
- **Timestamp:** 6:09
- **Dramaturgy Reference:** Close-up on seated Robotiko. A hand with a thick ring reaches from behind and touches his metal shoulder. Robotiko's eye-screen activates showing a newspaper headline about a predatory healer scandal.
- **Characters Present:** Robotiko (seated), Cinci Hoca (hand only)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
- **Timestamp:** 6:14
- **Dramaturgy Reference:** Robotiko bolts from the room, through the doorway, into daylight. Panicked sprint, feet sparking on pavement.
- **Characters Present:** Robotiko (running)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
- **Composition Notes:** Motion shot. Chrome android bursting through doorway into light. Street depth ahead.

**Text Prompt:**
> A battle-scarred chrome android bursting through an old wooden doorway into blinding daylight, mid-sprint, arms pumping. Chrome feet striking the pavement with sparks flying. The narrow street stretching ahead. Motion blur on the background. Sharp contrast between the dark interior behind and the harsh daylight ahead. 16:9 widescreen composition, hyper-realistic, 70s progressive rock album art style, Frank Frazetta meets Syd Mead, Kodachrome film stock, heavy film grain, cinematic lighting, volumetric fog, 8k resolution, masterpiece.
...
#### Scene S32 — The Running Continues
- **Timestamp:** 6:19
- **Dramaturgy Reference:** Robotiko sprints through changing landscapes — narrow street to highway shoulder to bridge approach. Backgrounds smear past him.
- **Characters Present:** Robotiko (running)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
#### Scene S33 — The Bosphorus Bridge (Miniature)
- **Timestamp:** 6:28
- **Dramaturgy Reference:** Bosphorus Bridge rendered in miniature/tightrope perspective. The bridge feels impossibly thin, fragile. Robotiko walking as if balancing on a blade.
- **Characters Present:** Robotiko
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
#### Scene S34 — The Slip
- **Timestamp:** 6:35
- **Dramaturgy Reference:** Robotiko's foot slips on the bridge. Slow-motion fall. Caught between bridge and sea.
- **Characters Present:** Robotiko (falling)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
- **Timestamp:** 6:42
- **Dramaturgy Reference:** Packed Istanbul metrobüs interior. Extreme crowd density. Bodies pressing against chrome from all sides.
- **Characters Present:** Robotiko, Metrobüs Passengers (mixed crowd)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
#### Scene S36 — Folded Up
- **Timestamp:** 6:47
- **Dramaturgy Reference:** The crowd physically compresses Robotiko. His chrome body bends, shoulders cave, head drops. Folded like cloth.
- **Characters Present:** Robotiko (folded), Metrobüs Passengers
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
#### Scene S37 — Amber Flood
- **Timestamp:** 6:53
- **Dramaturgy Reference:** The entire metrobüs interior floods with amber light, replacing the fluorescent. Robotiko folded in the crowd, bathed in amber.
- **Characters Present:** Robotiko (folded in crowd). Mentor atmospheric — maximum intensity.
- **Image Reference Path:** N/A
- **Video Tech Strategy:** Standard
...
- **Timestamp:** 7:02
- **Dramaturgy Reference:** Mentor stands on the metrobüs overpass, facing camera, breaking fourth wall. Behind him in shallow focus: Robotiko being carried overhead by the crowd.
- **Characters Present:** Mentor (foreground, facing camera), Robotiko (background, carried by crowd)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`, `_assets/cast/ref_mentor_master.png`
- **Video Tech Strategy:** Standard
...
- **Timestamp:** 7:14
- **Dramaturgy Reference:** Wide shot: the overpass, now empty. Mentor gone. Traffic continues below. City lights flickering on.
- **Characters Present:** None. Empty frame.
- **Image Reference Path:** N/A
- **Video Tech Strategy:** Standard
- **Composition Notes:** Wide establishing shot. Empty concrete structure. Highway below. Urban twilight depth.

**Text Prompt:**
> A concrete pedestrian overpass at twilight, completely empty. No figures. The highway below continues with headlights and taillights streaming in both directions. City lights beginning to flicker on in the background. The concrete railing where a figure once stood is bare. Urban night approaching, exhaust haze rising from the highway. 16:9 widescreen composition, hyper-realistic, 70s progressive rock album art style, Frank Frazetta meets Syd Mead, Kodachrome film stock, heavy film grain, cinematic lighting, volumetric fog, 8k resolution, masterpiece.
...
#### Scene S40 — The Ambulance
- **Timestamp:** 7:27
- **Dramaturgy Reference:** An ambulance with red crescent pulls into a sanayi sitesi (industrial zone). Low concrete buildings, roll-up doors, oil stains, stacked tires.
- **Characters Present:** Sanayi workers (watching from doorways)
- **Image Reference Path:** N/A
- **Video Tech Strategy:** Standard
...
- **Timestamp:** 7:42
- **Dramaturgy Reference:** Robotiko carried on a medical stretcher into a kaynakçı (welder's) workshop. Medical stretcher, industrial destination.
- **Characters Present:** Robotiko (on stretcher), Workshop Workers (2-3)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
- **Timestamp:** 7:58
- **Dramaturgy Reference:** The kaynakçı stands over Robotiko wearing a doctor's coat over work coveralls, welding mask flipped up, holding a welding torch.
- **Characters Present:** Robotiko (on bench), Kaynakçı-Doctor
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
- **Timestamp:** 8:15
- **Dramaturgy Reference:** Close-up: IV drip connected to Robotiko's forearm. The IV bag contains gres yağı (grease) — amber-brown, viscous, dripping slowly through transparent tube.
- **Characters Present:** Robotiko (on bench, watching IV)
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
- **Composition Notes:** Close-up on IV bag and tube. Robotiko's face partially visible. Intimate framing.

**Text Prompt:**
> Close-up: a transparent IV bag hanging from a metal stand, filled with amber-brown viscous grease instead of saline. The grease drips slowly through a transparent tube, each drop heavy and deliberate. The tube connects to a port on a chrome forearm lying on a workshop bench. The battle-scarred chrome android's face partially visible, blue eyes open, watching the drip. Workshop light catching the amber grease in the tube. 16:9 widescreen composition, hyper-realistic, 70s progressive rock album art style, Frank Frazetta meets Syd Mead, Kodachrome film stock, heavy film grain, cinematic lighting, volumetric fog, 8k resolution, masterpiece.

---

#### Scene S44 — Slow Zoom Out
- **Timestamp:** 8:30
- **Dramaturgy Reference:** Slow pull-back: grease IV → Robotiko on bench → kaynakçı standing → workshop interior → sanayi exterior at night. Stray cat at entrance. Final Gong.
- **Characters Present:** Robotiko (on bench, still), Kaynakçı-Doctor, Stray Cat
- **Image Reference Path:** `_assets/cast/ref_robotiko_master.png`
- **Video Tech Strategy:** Standard
...
- [x] Every prompt ends with the mandatory style suffix
- [x] Every scene with a character references the correct master image path
- [x] Character visual state matches Phase 1 (EP02 damage carries)
- [x] No forbidden aesthetics present in any prompt
- [x] All prompts composed with headroom and breathing space (16:9 widescreen)
- [x] Total prompt count (44) matches approved dramaturgy scene count (44)
- [x] No camera directions in prompts (reserved for motion script)
- [x] No emotional/narrative language — only visually renderable descriptions
- [x] Short character identifiers used — reference images carry visual details
- [x] Mixed gender representation in all crowd/group scenes
- [x] Anti-guru: all locations are modern Anatolian reality

---

## NOTES FOR HUMAN REVIEW

1. **S04 — Text legibility: RESOLVED.** Two-image solution: 4.png (wide shot, Mentor at CRT) + 4.1.png (screen close-up, text legible). Motion script will use multi-shot: wide → screen zoom.
2. **S33-S34 — Miniature bridge: RESOLVED.** Reverse forced perspective (giant Robotiko on real-scale bridge) accepted as creative choice — visually striking and unique.
3. **S38 — Two-plane composition: RESOLVED.** Image generation successfully rendered Mentor foreground + crowd-surfing Robotiko background with depth-of-field separation. No post-processing needed.
4. **Scene count:** Dramaturgy header says 40, actual breakdown has 44 scenes. Prompts generated for all 44.
5. **v02 change:** All prompts rewritten for tool-friendly clarity. Long Robotiko descriptions replaced with "a battle-scarred chrome android" — reference image carries visual identity. Narrative/emotional commentary removed.
