...
- [ ] `episode-09/02_music/ep09_musical_metadata.json` → Sections, timestamps, energy, mood
- [ ] `episode-09/03_direction/ep09_concept_notes.md` → User must-haves and overrides
...
*(Auto-extracted from ep09_musical_metadata.json)*
