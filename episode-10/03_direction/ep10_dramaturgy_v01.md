...
- [ ] `episode-10/02_music/ep10_musical_metadata.json` → Sections, timestamps, energy, mood
- [ ] `episode-10/03_direction/ep10_concept_notes.md` → User must-haves and overrides
...
*(Auto-extracted from ep10_musical_metadata.json)*
