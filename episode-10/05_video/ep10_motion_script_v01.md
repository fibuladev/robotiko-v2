...
- [ ] `episode-10/03_direction/ep10_dramaturgy.md` → APPROVED scene breakdown
- [ ] `episode-10/04_visuals/selected/` → Selected images confirmed
- [ ] `episode-10/02_music/ep10_musical_metadata.json` → Beat sync reference
...
**Assets Required:**
- **Start Frame:** `episode-10/04_visuals/selected/ep10_s{XX}_selected.png`
- **End Frame:** `episode-10/04_visuals/selected/ep10_s{XX}_selected.png` *(Mode B only — else N/A)*
...
**Assets Required:**
- **Start Frame:** `episode-10/04_visuals/selected/ep10_s{XX}_selected.png` *(same image, different camera move)*
...
**Expected Selected Image:** `episode-10/04_visuals/selected/ep10_s{XX}c_selected.png`
