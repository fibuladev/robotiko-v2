...
### 1. `34b.mp4` is 720p — the series' final shot

| Clip | Resolution | Every other clip |
|---|---|---|
| `34b.mp4` (S34b — The Beckon) | **1280×720** | 1920×1080 |

This is the last frame of the album: the head tilt, the machine's smile, the open-palm beckon. Upscaled
to 1080p it will read slightly softer than its neighbours — partly masked by film grain and the 2.35:1
crop, but it sits directly beside `34.mp4` (1080p) in a static two-shot pair, which is the worst case
for a visible resolution step. **Recommendation: re-render S34b at 1080p** (it is OmniEdit priority 1 in
the motion script and the retake budget exists). If you accept the 720p keeper, that is a legitimate call —
the guide works either way.
...
- [ ] ⚠️ 34b.mp4  S34b  10.01s  (Kling 3.0 — Mode B) — **720p, see Pre-Flight §1**
...
| S34a | 4:16–4:23 | 34.mp4 | 7s | 8s | — | trim 1s |
| S34b | 4:23–4:30 | 34b.mp4 | 7s | 10s | — | trim 3s |
...
- **S34 (4:16–4:30, 14s)** — S34a The Look (7s) then S34b The Beckon (7s). The look must **land and hold**
  before the tilt arrives; do not shorten S34a to give S34b room. The offered hand reaches full extension
  in S34b's last second (4:29–4:30), where the gong cuts it.

---

## 4. SPEED TABLE

28 clips need a speed adjustment. They split into two kinds — treat them differently.
...
**Trims (5):** S02 (1s), S08a (1s), S08b (1s), S34a (1s), S34b (3s). Cut from the **end** in all cases
except **S34b — cut from the START**: the beckon must arrive late, in the final breath, and the offered
hand must be at full extension when the gong lands.
...
4. Proposed text — **your approval needed:**

```
THE FULL SCORE IS PUBLIC.
...
- [ ] All 28 speed values match §4 exactly (5 curves, 23 uniform)
- [ ] All 5 trims applied; **S34b trimmed from the START**, not the end
...
- [ ] S34b resolution decision made (720p accepted, or re-rendered at 1080p)
